...
router.get('/', async (req, res) => {
    try {
        ...
        console.log('📚 Obteniendo artículos:', { status, category, chapter, page, limit });
        ...
        console.log(`✅ Encontrados ${result.rows.length} artículos`);
...
router.post('/', authenticateToken, async (req, res) => {
    try {
        ...
        console.log('📝 Creando nuevo artículo:', { title, category, chapter, status });
        ...
        if (status === 'pending') {
            ...
            console.log('🔔 Notificación creada para revisores');
        }

        console.log('✅ Artículo creado exitosamente:', newArticle.id);
...
router.get('/:id', async (req, res) => {
    try {
        ...
        console.log('📖 Obteniendo artículo:', id);
...
router.put('/:id', authenticateToken, async (req, res) => {
    try {
        ...
        console.log('✏️ Actualizando artículo:', { id, title, status });
